...
Inclui **38 aulas introdutórias**, **19 módulos**, **134 exercícios** e **8 planos de cadeira + ponte de bases**. Cada aula é um HTML separado. O índice contém apenas entradas e não carrega o curso completo.
...
- B01 a B05 completas com sete exercícios cada; restantes aulas ainda introdutórias com três, até ao respetivo aprofundamento. No calendário há espaço para revisão e código.
