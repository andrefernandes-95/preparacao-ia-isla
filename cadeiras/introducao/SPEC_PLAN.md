# SPEC_PLAN — Introdução à Inteligência Artificial
...
## Objetivo
Distinguir os tipos de IA e formular problemas que podem ser avaliados com dados.

## Pré-requisitos
Funções e percentagens; não exige cálculo universitário.
...
- [I02 — Supervisão, grupos e recompensas](modulo-1/i02.html): Escolher um paradigma a partir da informação disponível. Pré-requisitos: I01.

### Módulo 2 — Procura e responsabilidade
- [I03 — Procura: estados, ações e caminhos](modulo-2/i03.html): Descrever uma procura em largura num grafo pequeno. Pré-requisitos: Listas e ciclos.
- [I04 — Riscos, enviesamento e decisões humanas](modulo-2/i04.html): Avaliar quem pode ser prejudicado por um erro. Pré-requisitos: I02 e B01.

## Aprofundamento planeado — ainda por desenvolver em HTML
### AP1 — História da IA, representação de conhecimento e lógica
...
### AP2 — Procura informada e heurísticas
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
### AP3 — Aprendizagem por reforço: estados, ações e recompensas
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
### AP4 — Ética, explicabilidade e documentação de dados
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
## Projeto
Escrever uma proposta para classificar pedidos de suporte, incluindo alternativa sem IA e riscos.

## Avaliação proposta
Problema delimitado, entradas disponíveis no momento de uso, métrica e análise de falhas concretas.
