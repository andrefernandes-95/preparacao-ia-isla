...
## Objetivo
Construir e avaliar modelos simples, protegendo a experiência contra fuga de informação.

## Pré-requisitos
Python, matrizes, médias e divisão entre treino e teste.
...
- [ML02 — Classificação e matriz de confusão](modulo-1/ml02.html): Calcular precisão e sensibilidade sem trocar denominadores. Pré-requisitos: M03 e I02.

### Módulo 2 — Generalizar e descobrir
- [ML03 — Sobreajustamento e validação](modulo-2/ml03.html): Reconhecer memorização e impedir fuga de informação. Pré-requisitos: P04 e ML01.
- [ML04 — Clustering e distância](modulo-2/ml04.html): Atribuir pontos a centros e questionar o significado dos grupos. Pré-requisitos: M01 e B04.

## Aprofundamento planeado — ainda por desenvolver em HTML
### AP1 — Regressão logística, árvores, ensembles e regularização
...
### AP2 — Validação cruzada, pipelines e procura de hiperparâmetros
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
### AP3 — Desequilíbrio, calibração e escolha de limiares
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
### AP4 — PCA, clustering e avaliação sem rótulos
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
## Projeto
Executar o laboratório de classificação de pedidos de suporte e escrever uma análise de erros.

## Avaliação proposta
Referência explícita, teste separado, métrica adequada e limitações; pontuação alta por si só não basta.
