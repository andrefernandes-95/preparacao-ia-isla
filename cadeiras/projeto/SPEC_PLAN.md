...
## Objetivo
Transformar os conhecimentos num pequeno projeto defensável e reproduzível.

## Pré-requisitos
Programação e Machine Learning; NLP se escolheres o projeto de suporte.
...
- [F02 — Dados, rótulos e divisão](modulo-1/f02.html): Criar um protocolo de anotação e avaliação. Pré-requisitos: P03 e P04.

### Módulo 2 — Entregar e defender
- [F03 — Comparar e analisar erros](modulo-2/f03.html): Construir uma tabela de resultados e tirar conclusões limitadas. Pré-requisitos: ML02–ML03 e N02.
- [F04 — Entregar, demonstrar e defender](modulo-2/f04.html): Explicar o que fizeste e o que os resultados permitem concluir. Pré-requisitos: F01–F03.

## Aprofundamento planeado — ainda por desenvolver em HTML
### AP1 — Recolha e anotação de dados com critérios consistentes
...
### AP2 — Experiências comparativas e ablações
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
### AP3 — Relatório técnico e demonstração
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
### AP4 — Defesa oral e plano de evolução
- Preparar 2–3 aulas de 60 minutos, começando pelos pré-requisitos das aulas introdutórias.
- Explicar conceitos e notação, resolver um exemplo numérico mínimo e uma aplicação a dados de suporte ou interfaces.
- Laboratório: comparar a técnica com o método introdutório correspondente e registar pressupostos e limitações.
- Aceitação: explicar a técnica, executar um exemplo reproduzível e justificar quando a escolha é inadequada.
...
## Projeto
Assistente de triagem de suporte: sugerir categoria, permitir correção e medir falhas por categoria.

## Avaliação proposta
Problema 15%, dados 20%, avaliação 25%, implementação 20%, comunicação e reflexão 20%. Grelha proposta, não oficial.
