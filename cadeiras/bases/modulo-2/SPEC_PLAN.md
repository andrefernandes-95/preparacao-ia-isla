...
## Perfil e dependências
Programador front-end com bases frágeis. Concluir B01 e B02 antes de começar. Traduzir números e expressões para relações, gráficos e descrições de dados. Nenhuma derivada ou inferência formal é pré-requisito.

## Ritmo
Uma semana de 4 horas por aula: duas sessões de 60 minutos para compreender e duas horas de exercícios, código e revisão a 48 horas. O calendário introdutório não deve ser acumulado com esta carga.

## B03 — Funções, gráficos e potências
- Sequência: entrada/regra/saída → domínio, contradomínio e imagem → tabela e coordenadas → escala dos eixos → reta e taxa média → zeros → potência e raiz → crescimento exponencial e logaritmo → composição.
- Resultados: ler e construir uma tabela, representar pontos, interpretar declive e unidades, resolver uma pergunta inversa, distinguir crescimento linear/quadrático/exponencial.
