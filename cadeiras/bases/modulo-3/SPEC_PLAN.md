# Módulo 3 — Preparação do ambiente e diagnóstico

## Objetivo e perfil
Concluir a ponte de bases com um ambiente Python verificável e um diagnóstico que determine revisões concretas. Destinatário: programador front-end com pouca experiência em Python e matemática universitária. B01–B04 são pré-requisitos de B06; B05 não pressupõe bibliotecas de IA.

## Ritmo
4 horas por semana. B05: duas sessões de 60 minutos e duas horas de prática/revisão. B06: 45 minutos de diagnóstico, 45 de correção, 90 de revisão dirigida e 60 de nova tentativa após 48 horas. Não acumular esta carga com o calendário introdutório original.

## B05 — Ambiente Python e primeiro script
- Inspecionar instalação existente antes de instalar; distinguir terminal, intérprete interativo e ficheiro.
- Criar ambiente isolado, identificar executável e pasta de trabalho, executar script do princípio ao fim.
- Explicar print, listas, sum, len e divisão; lidar com lista vazia; produzir JSON sem bibliotecas externas.
- Distinguir pacote externo de biblioteca padrão; usar pip com o mesmo intérprete; compreender requisitos e registo de versões.
